	...
	var helios_settings = {
		...
		// skelJS (probably don't need to change anything here unless you know what you're doing)
			skelJS: {
				...
				breakpoints: {
					'widest':	{ range: '1680-', hasStyleSheet: false, containers: 1024 },
					'wide':		{ range: '-1680', containers: 1024 },
					'normal':	{ range: '-1280', containers: 'fluid', grid: { gutters: 36 }, viewportWidth: 1024 },
